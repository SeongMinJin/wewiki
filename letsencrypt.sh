...
domains="wewiki.me" # 자신의 도메인
rsa_key_size=4096
data_path="/home/wewiki/app/certbot" # host에 마운트된 certbot 디렉토리
email="sorksoek2@gmail.com" # 업데이트 등 정보 수신 메일 입력 (권장?)
staging=1 # 시간당 5번의 요청 제한으로 1로 설정 시 테스트 진행(요청 카운팅 안 됨)
